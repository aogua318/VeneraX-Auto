...
class _BookshelfPageState extends State<BookshelfPage> {
  ...
  void deleteSelectedComics() async {
    ...
    // VeneraX deletes files in a background isolate without per-file
    // progress; the database is updated synchronously.
    LocalManager().batchDeleteComics(localComics, true, true);
